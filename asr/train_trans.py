...
def main():
    ...
    tokenizer = ASRTokenizer(config['dataset']['tokenizer'], ctc_decode=True, insert_space=False)
    ...
    for epoch in range(1, config['max_epochs']+1):
        ...
        val_cer = solver_trans.test(network, device, valid_loader, epoch, iter_meter, writer)
